...
1. Configure the plugin by going into Training Courses-->MemberPress, then associate courses with products (this assumes you already have courses and products created).
...
Click here to get [MemberPress](http://flyplugins.com/memberpress).
